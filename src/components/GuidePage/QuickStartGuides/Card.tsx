...
type CardProps = {
  ...
  description: string;
  buttonText: string;
  href: string; // ✅ เพิ่ม href เพื่อให้ปุ่มใช้งานได้
} & QwikIntrinsicElements["div"];

export const Card = component$<CardProps>(
  ({ title, subtitle, description, buttonText, href, ...props }) => (
    <div
      {...props}
    ...
    >
      <div class="flex flex-col pt-3 bg-gray-800">
        ...
        <a
          href={href}
          class="self-start px-6 py-2 mt-9 text-base font-medium tracking-wider leading-none text-center text-gray-800 bg-white rounded-2xl max-md:px-5 hover:bg-gray-200 transition"
        >
          {buttonText}
        </a>
