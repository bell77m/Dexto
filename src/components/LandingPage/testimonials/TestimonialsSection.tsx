...
const testimonials: TestimonialProps[] = [
  {
    ...
    imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/4d2e926641666a8396876e6c7df746d9acdbdec831b2229cdb4ba898b927a1b3?placeholderIfAbsent=true&apiKey=83086b8ef5ae4f9392edc247fd20d152"
  },
  {
    name: "Sasikhet M",
    role: "Co-Founder PonHab",
...
export const TestimonialsSection = component$(() => {
  return (
    <div class="flex overflow-hidden flex-col items-center pt-24 pb-52 w-full bg-gray-900 max-md:pb-24 max-md:max-w-full">
      ...
      <div class="overflow-hidden self-stretch mt-20 mb-0 w-full max-md:mt-10 max-md:mb-2.5 max-md:max-w-full">
        <div class="flex gap-5 max-md:flex-col">
          {testimonials.map((testimonial, index) => (
            <div key={index} class="flex flex-col w-1/3 max-md:ml-0 max-md:w-full">
